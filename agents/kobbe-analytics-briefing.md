...
Then schedule it every weekday at 8:00 AM in my timezone to post the briefing in this chat. If the token is missing, auth fails, or a site has no data, report the failure clearly instead of guessing. Save the agent when I approve the test run.
